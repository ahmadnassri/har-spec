...
| ------------------------- | --------- | --------- | ------- | ----------------------------------------------------------------------------------------------------------------- |
| **version**               | `string`  | yes       | `1.3`   | Version number of the format                                                                                      |
...
| **comment**               | `string`  | no        | `N/A`   | A comment provided by the user or the application                                                                 |
...
| **connection**            | `string`  | no        | `N/A`   | Unique ID of the parent TCP/IP connection, can be the client or server port number.                                                                 |
| **comment**               | `string`  | no        | `N/A`   | A comment provided by the user or the application                                                                                                   |
...
| **headersCompression**            | `number`  | no        | `N/A`   | *(new in 1.3)* Number of bytes saved (for [`HTTP/2`][rfc7540-headers])                                                   |
...
| **secure**    | `boolean` | no        | `N/A`   | true` if the cookie was transmitted over ssl, `false` otherwise                    |
| **comment**   | `string`  | no        | `N/A`   | A comment provided by the user or the application                                   |
...
| **encoding**          | `string`  | no        | `N/A`   | *(new in 1.3)* - Encoding used for request `text` field e.g "base64" |
| **comment**           | `string`  | no        | `N/A`   | A comment provided by the user or the application                    |
...
| **encoding**      | `string`  | no        | `N/A`   | *(new in 1.3)* - Encoding used for `value` field e.g "base64"       |
| **comment**       | `string`  | no        | `N/A`   | A comment provided by the user or the application                   |
