...
This object contains list of all headers (used in [`request`](#request) and [`response`](#response) objects, and now [`params`](#params) objects).
...
| **serverIPAddress**      | `string`  | ✔️        | `N/A`    | *(new in 1.3)* - IP address of the server.                        |
| **clientPort**           | `number`  | ✔️        | `N/A`    | *(new in 1.3)* - TCP port of the client.                          |
| **serverPort**           | `number`  | ✔️        | `N/A`    | *(new in 1.3)* - TCP port of the server.                          |
| **lingerEnabled**        | `boolean` | ✖️        | `false`  | *(new in 1.3)* - The first component of (SOL_SOCKET, SO_LINGER).  |
| **lingerSeconds**        | `string`  | ✖️        | `-1`     | *(new in 1.3)* - The second component of (SOL_SOCKET, SO_LINGER). |
